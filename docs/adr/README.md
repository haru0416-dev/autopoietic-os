...
| [0016](0016-evidence-bundle-and-canonical-comparison-boundary.md) | Accepted | Evidence bundleとcanonical comparisonで情報受け渡しを固定する |
| [0017](0017-p4-organ-registry-and-decay-review-boundary.md) | Accepted | P4はorgan registryとdecay reviewに限定する |
